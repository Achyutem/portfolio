...
## ⚙️ Step 1: Node.js Backend Setup
...
## ⚙️ Step 2: Running Node with systemd
...
## 🖥️ Step 4: (Optional) Running with tmux
...
_Authored by: Achyutem Dubey
Documented for internal developer use and VM-based deployments._
